...
async function executeAiGeneration(basePrompt, retryWarning = "") {
    ...
    if (isValidKey(geminiKey, 'gemini')) {
        try {
            ...
            const result = await timeoutPromise(GeminiModel.generateContent(fullPrompt), 4000, "Gemini Canned Generation");
...
4. Tone: Helpful, highly professional, connected, in simple English and clear.
